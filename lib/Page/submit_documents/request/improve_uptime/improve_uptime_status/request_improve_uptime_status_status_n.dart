...
class request_improve_uptime_status_approved extends StatefulWidget {
  ...
  @override
  State<request_improve_uptime_status_approved> createState() => _request_improve_uptime_status_approvedState();
}

class _request_improve_uptime_status_approvedState extends State<request_improve_uptime_status_approved> {
  int countLeaveW =0;
  @override
  void initState() {
    shareprefs();
    ...
    try {
      ...
      setState(() {
       ...
       countLeaveW = add_time_List
          .where(
              (_approveList) => _approveList.statusApprove == 'approved')
          .length; 
      });
    ...
    return loading
       ...
       countLeaveW == 0
            ...
            itemBuilder: (context, index) {
              ...
              return add_time_List[index].statusApprove == 'approved'
                      ? Column(
