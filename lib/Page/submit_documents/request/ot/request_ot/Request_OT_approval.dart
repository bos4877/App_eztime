...
import 'package:eztime_app/Page/submit_documents/logRequest/request_ot.dart';
...
class _Request_OT_approvalState extends State<Request_OT_approval> {
  ...
  Future ad_ot(
      ot_id,startDate,endDate,description,shift_date) async {
    setState(() {
      loading = true;
    });
    try {
                    ...
                    child: IconButton(
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => tapbar_logrequest_ot(),
                          ));
                        },
            ...
            bottomNavigationBar: Container(
              ...
              child: Buttons(
                  ...
                  press: () {
                    ...
                    ad_ot(otid, start, enddates,leaveDescription.text,shift_date);
                  }),
            ),
            body: ListView(
                      ...
                      Material(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle: TextStyle(
                                color: Theme.of(context).primaryColor), // สีข้อความในฮินท์
                            prefixIcon:
