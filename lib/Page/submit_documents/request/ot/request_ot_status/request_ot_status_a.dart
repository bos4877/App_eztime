...
class _request_ot_status_ApprovedState
    extends State<request_ot_status_Approved> {
  int countLeaveW = 0;
  @override
  void initState() {
    shareprefs();
  ...
  Future _get_ot() async {
    try {
      ...
      setState(() {
        otList = getoneot;
        countLeaveW =
            otList.where((_approveList) => _approveList.statusApprove == 'approved').length;
      });
    } catch (e) {
      log(e.toString());
    } finally {
        ...
        : countLeaveW == 0
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  int docOtApproveleng = otList[index].docOtApprove!.length -1;
                  String status;
                  ...
                  return docotApprove![docOtApproveleng].status == 'approved'
                      ? Column(
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                                'OT_request_list.Approval_authority'
                                                    .tr()),
                                            ListView.builder(
                                                shrinkWrap: true,
