...
import 'package:eztime_app/Page/submit_documents/request/ot/request_ot_status/request_ot_status_a.dart';
import 'package:eztime_app/Page/submit_documents/request/ot/request_ot_status/request_ot_status_n.dart';
import 'package:eztime_app/Page/submit_documents/request/ot/request_ot_status/request_ot_status_w.dart';
...
class _tapbar_logrequest_otState extends State<tapbar_logrequest_ot>
  ...
  final _tabs = [
    ...
    Tab(text: 'OT_request_list.Not_approved'.tr()),
  ];
  @override
  void initState() {
   ...
   final _selectedColor = Theme.of(context).primaryColor;
    return Scaffold(
        ...
        body: TabBarView(
          ...
          request_ot_status_Not_approved()
        ]));
  }
}
