...
import 'package:eztime_app/Page/submit_documents/appeove/improve_uptime/improve_uptime_status/approve_status_a.dart';
import 'package:eztime_app/Page/submit_documents/appeove/improve_uptime/improve_uptime_status/approve_status_n.dart';
import 'package:eztime_app/Page/submit_documents/appeove/improve_uptime/improve_uptime_status/approve_status_w.dart';
...
class _tapbar_apporv_improve_uptimeState extends State<tapbar_apporv_improve_uptime>
  ...
  final _tabs = [
    ...
    Tab(text: 'Apporv_Improve_Uptime.Not_approved'.tr()),
  ];
  @override
  void initState() {
   ...
   final _selectedColor = Theme.of(context).primaryColor;
    return Scaffold(
        ...
        body: TabBarView(
          ...
          status_Not_approved_improve_uptime()
        ]));
  }
}
