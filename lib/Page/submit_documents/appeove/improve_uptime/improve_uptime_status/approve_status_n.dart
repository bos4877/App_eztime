...
class status_Not_approved_improve_uptime extends StatefulWidget {
  const status_Not_approved_improve_uptime({super.key});

  @override
  State<status_Not_approved_improve_uptime> createState() =>
      _status_Not_approved_improve_uptimeState();
}

class _status_Not_approved_improve_uptimeState
    extends State<status_Not_approved_improve_uptime> {
  int countotN = 0;
  @override
  void initState() {
    shareprefs();
    ...
    try {
     var response = await get_approve_addtime_list_Service().model(token);
       ...
       _addtime = response;
          countotN = _addtime
            .where((addtime) =>
                addtime.statusAprrove == 'cancelled')
            .length;
