...
class status_waiting_ot extends StatefulWidget {
  const status_waiting_ot({super.key});

  @override
  State<status_waiting_ot> createState() => _status_waiting_otState();
}

class _status_waiting_otState extends State<status_waiting_ot>
                                      ...
                                      ButtonTwoAppprove(
                                        onPressBtSucess: () async {
                                          ...
                                          var response =
                                            ...
                                            if (result == 200) {
                                              Dialog_Success.showCustomDialog(
                                                  context);
                                            } else {
