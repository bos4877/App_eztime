...
import 'package:eztime_app/Page/documents/request/leave/request_leave_status/request_leave_status_a.dart';
import 'package:eztime_app/Page/documents/request/leave/request_leave_status/request_leave_status_n.dart';
import 'package:eztime_app/Page/documents/request/leave/request_leave_status/request_leave_status_w.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: TabBarView(controller: _tabController, children: [
          ...
          request_leave_status_cancelled()
        ]));
  }
}
