...
import 'package:eztime_app/Page/documents/request/improve_uptime/improve_uptime_status/request_improve_uptime_status_status_a.dart';
import 'package:eztime_app/Page/documents/request/improve_uptime/improve_uptime_status/request_improve_uptime_status_status_n.dart';
import 'package:eztime_app/Page/documents/request/improve_uptime/improve_uptime_status/request_improve_uptime_status_status_w.dart';
   ...
   final _selectedColor = Theme.of(context).primaryColor;
    return Scaffold(
        ...
        body: TabBarView(
          ...
          request_improve_uptime_status_cancelled()
        ]));
  }
}
